...
-   You are **not required to fill an entire page per lecture reading or video**. Instead, make sure you clearly **write the title of each reading/video** at the top of its section and **capture the main points and key concepts** from the video. Your notes should show that you actively engaged with the material and understood the core ideas.

-   I'll quickly review your notes to see if they meaningfully reflect the content. If key ideas are missing, you won't receive the completion point.

### 📤 If You Can\'t Make It to Class {#if-you-cant-make-it-to-class data-start="830" end="867"}

-   Scan your handwritten notes as a **PDF and upload them before class time** begins.

-   I recommend using the free **Adobe Scan** app on your phone for this.

### ⚠️ Forgetting Notes {#forgetting-notes data-start="1026" end="1050"}

-   If you forget to bring your notes **and** didn't submit them online before class time, you won't get the completion point.

-   To be safe, you may submit them online *and* bring them to class.
...
The Cornell Note-Taking System isn't just a way to take notes, it's a **thinking system** designed to help you *understand, organize, and remember* what you're learning. It was developed at Cornell University and is backed by learning science.

By using Cornell Notes, you'll come to class more prepared, get more out of our in-class activities, and set yourself up for stronger exam performance.

## How to take Cornell Notes? {#how-to-take-cornell-notes data-start="1020" end="1267"}

For more information on this system:

👉 [Cornell Note-Taking System -- Cornell Learning Strategies Center](https://lsc.cornell.edu/how-to-study/taking-notes/cornell-note-taking-system/){target="_new" data-start="545" end="689"}
