---
title: How To Find Due Dates Using Canvas Calendar
published: true
---
...
!["Canvas LMS navigation menu for IT-CS 115, with red arrows pointing to "Calendar" icon in the left-most column of Canvas-wide navigation options."](../../assets/images/canvas_navigation/canvas_course_navigation_sidebar.png)

At this point you\'re probably looking at a wall of appointments, and probably feeling a bit overwhelmed:

![A digital calendar displaying November 2023 in month view, showing multiple color-coded academic events and assignments scheduled throughout the month.](../../assets/images/canvas_calendar/canvas_calendar_month_view.png){style="display: block; margin-left: auto; margin-right: auto;" width="543" height="236"}
...
![A digital calendar showing November 2023 in month view, with red arrows pointing to multiple course calendars listed in a sidebar panel.](../../assets/images/canvas_calendar/canvas_calendar_course_list.png){style="display: block; margin-left: auto; margin-right: auto;"}
...
![A digital calendar app showing a monthly view with color-coded events and a sidebar listing multiple calendars and upcoming assignments.](../../assets/images/canvas_calendar/canvas_calendar_assignments_view.png){style="display: block; margin-left: auto; margin-right: auto;"}(Your calendar may look different than mine - Canvas crosses out Assignments that I\'ve finished grading which is why some of the Assignments are crossed out)
